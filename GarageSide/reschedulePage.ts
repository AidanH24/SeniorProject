const rescheduleMonthSelect = document.getElementById('monthSelect') as HTMLSelectElement;
const rescheduleDaySelect = document.getElementById('daySelect') as HTMLSelectElement;
const rescheduleTimeSelect = document.getElementById('timeSelect') as HTMLSelectElement;
const rescheduleSummary = document.getElementById('summary') as HTMLDivElement;
...
const confirmRescheduleBtn = document.getElementById('confirmBtn') as HTMLButtonElement;
